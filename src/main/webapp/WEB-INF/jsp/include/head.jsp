			...
			<ul class="nav navbar-nav navbar-right">
				<li><span class="li-text"></span> <span class="li-text">
					...
					<div>
						...
						<c:if test="${userInfo.userIdenf != null}">
							<a class="navbar-brand" style="font-size: 12px;" href=" /userCenter"><strong><font color="#fff">欢迎您,${userInfo.userName }</font></strong></a>
							<a class="navbar-brand" style="font-size: 12px;"
								href="<c:url value="/logOff" />"><strong>注销</strong></a>
						</c:if>
						<a class="navbar-brand" style="font-size: 12px;" href=" /help"><strong>帮助中心</strong></a>
					</div></li>
			</ul>
		</div>
	</div>
